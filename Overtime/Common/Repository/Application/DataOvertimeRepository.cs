...
namespace Common.Repository.Application
{
    public class DataOvertimeRepository : IDataOvertime
    {
        ...
        {
            var get = myContext.DataOvertimes.Where(x => (x.Pay_Overtime.ToString().Contains(values) || x.Id.ToString().Contains(values) || x.Attachment_Overtime.Contains(values) || x.Employee_Id.ToString().Contains(values) || x.Type_Id.ToString().Contains(values)) && x.IsDelete == false).ToList();
            return get;
        }
